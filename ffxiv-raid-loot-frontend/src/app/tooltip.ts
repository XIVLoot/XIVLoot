...
export const deletePlayerToolTip = `Click to delete the player. Only static members can delete players and only alt players can be deleted. This action is non reversible.`;
